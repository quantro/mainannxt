...
export default function QrCodePage() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen px-4 py-12">
      ...
      <h1 className="cosmic-headline text-[34px] leading-[1.47] tracking-[-0.374px] mb-2">QR Code Generator</h1>
      ...
      <div className="w-full max-w-md space-y-4">
        <div className="cosmic-card px-5 py-4">
          ...
          <textarea
            ...
            rows={3}
            className="cosmic-input w-full resize-none text-[14px]"
          />
        </div>
        ...
        <div className="cosmic-card px-5 py-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3 text-[13px]">
            <div>
              ...
              <select value={errorLevel} onChange={(e) => setErrorLevel(e.target.value as any)} className="cosmic-input w-full h-9 text-[12px]">
        ...
        <div className="cosmic-card px-5 py-5 flex flex-col items-center">
          {text.trim() ? (
            <>
              <canvas ref={canvasRef} className="rounded-[8px]" width={280} height={280} />
              <button onClick={doDownload} className="cosmic-btn-primary mt-3 px-5 py-1.5 text-[13px]">Download PNG</button>
            </>
          ) : (
